...
//uintptr_t FindA(HANDLE hProcess, uintptr_t ptr, offsets offsets)
//{
//	uint64_t nAddress = ptr;
//	if (ptr == 0)
//		return nAddress;
...
//
//
//	ReadProcessMemory(hProcess, (void*)nAddress, &nAddress, sizeof(nAddress), 0);
//	for (size_t i = 0; i != size; i++)
//		ReadProcessMemory(hProcess, (void*)(nAddress + offsets[i]), &nAddress, sizeof(nAddress), 0);
//	nAddress = nAddress + offsets[size];
//
//	return nAddress;
//}
//std::string readString(HANDLE hProcess, uint64_t Address, int size, offsets offsets)
//{
//	std::string ret;
//	if (Address == 0)
//		return ret;
//	uint64_t nAddress = FindA(hProcess, Address, offsets);
//	char* buffer = new char[size];
//	ReadProcessMemory(hProcess, (void*)nAddress, buffer, size, 0);
