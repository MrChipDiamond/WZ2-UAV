...
#define game_mode 0x15190DA8
namespace player_info
{
	constexpr auto local_index = 0xFE700;
	constexpr auto local_index_pos = 0x204;//0x1FC;
	constexpr auto size = 0x4410;
	constexpr auto valid = 0x2C8;
	constexpr auto team_id = 0x4370; //39 81 ? ? ? ? 0F 84 ? ? ? ? B8 ? ? ? ?
	constexpr auto position_ptr = 0x70;
	constexpr auto stance = 0x4E00;
	constexpr auto recoil_offset = 0x4BF00;
	constexpr auto dead_1 = 0x4390;
	constexpr auto dead_2 = 0x4307;
	constexpr auto loot_ptr = 0x152033F0;
	constexpr auto weapon_index = 0x1C8;
}

namespace bones
{
	constexpr auto bone_base_pos = 0xA04C4;
	constexpr auto size = 0x150;
	constexpr auto visible = 0x63540B0;
	constexpr auto weapon_definitions = 0x12C53580;
	constexpr auto loot_ptr = 0x15550530;
	constexpr auto distribute = 0xA07CEC8;
}

namespace view_port
{
	constexpr auto refdef_ptr = 0x11C297A0;
	constexpr auto camera_ptr = 0x1213FF70;
...
namespace client
{
	...
	constexpr auto name_array = 0x11D70F10;
...
namespace Lobby
{
	constexpr auto currentPlayerCountPtr = 0x1299D320;
}
...
{
	extern HWND hWind;
	extern uintptr_t base, baseModule;
	extern bool outlines_bones;
